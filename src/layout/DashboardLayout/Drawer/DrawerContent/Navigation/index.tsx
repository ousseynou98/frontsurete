...
export default function Navigation() {
  ...
  // Dashboard menu supprimé - on utilise seulement le menu statique
  // const dashboardMenu = MenuFromAPI();

  useLayoutEffect(() => {
    // Ne plus ajouter le menu Dashboard API - utiliser seulement les menus statiques adaptés au rôle
    setMenuItems(menuItem({ role }));
