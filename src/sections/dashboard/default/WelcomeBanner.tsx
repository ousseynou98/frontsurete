      ...
      <Grid container>
        <Grid size={{ md: 6, sm: 6, xs: 12 }}>
          <Stack sx={{ gap: 2, padding: 3 }}>
            <Typography variant="h2">Bienvenue sur Surete ANAM</Typography>
            <Typography variant="h6">
              Plateforme de gestion de la sûreté portuaire et aéroportuaire - Agence Nationale des Affaires Maritimes
            </Typography>
          </Stack>
        </Grid>
