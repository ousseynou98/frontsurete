    ...
    <>
      <Formik
        ...
        onSubmit={async (values, { setErrors, setStatus, setSubmitting }) => {
          // TODO: Implement registration with authService
          console.log('Registration not yet implemented with JWT');
          setErrors({ submit: 'Registration is currently disabled. Please contact administrator.' });
          setSubmitting(false);
        }}
      >
